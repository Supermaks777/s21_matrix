...
START_TEST(s21_mult_matrix_1) {
  // ошибка: пустые указатели на матрицы (вторая и результирующая)
 memory_counter = 0;
  matrix_t A = {};
...
START_TEST(s21_mult_matrix_2) {
  // ошибка: вторая матрица содержит бесконечность
 memory_counter = 0;
  matrix_t A = {};
  matrix_t B = {};
  matrix_t result = {};
...
START_TEST(s21_mult_matrix_3) {
  // ошибка: некорректные размеры матрицы
 memory_counter = 0;
  matrix_t A = {};
  matrix_t B = {};
  matrix_t result = {};
...
START_TEST(s21_mult_matrix_4) {
  // успех: неинициализированные значения
 memory_counter = 0;
  matrix_t A = {};
  matrix_t B = {};
  matrix_t result = {};
...
START_TEST(s21_mult_matrix_5) {
  // успех: инициализированные значения
 memory_counter = 0;
  matrix_t A = {};
  matrix_t B = {};
  matrix_t result = {};
...
START_TEST(s21_mult_matrix_6) {
 ...
 memory_counter = 0;
  ...
  s21_create_matrix(3, 3, &eq_matrix);
  eq_matrix.matrix[0][0] = 9, eq_matrix.matrix[0][1] = 11, eq_matrix.matrix[0][2] = 17;
  eq_matrix.matrix[1][0] = 12, eq_matrix.matrix[1][1] = 13, eq_matrix.matrix[1][2] = 22;
  eq_matrix.matrix[2][0] = 15, eq_matrix.matrix[2][1] = 15, eq_matrix.matrix[2][2] = 27;
  int err_code = s21_mult_matrix(&A, &B, &result);
  // s21_print_matrix(&result);
  // s21_print_matrix(&eq_matrix);

  ck_assert_int_eq(err_code, OK);
  ck_assert_int_eq(s21_eq_matrix(&result, &eq_matrix), SUCCESS);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
  s21_remove_matrix(&result);
